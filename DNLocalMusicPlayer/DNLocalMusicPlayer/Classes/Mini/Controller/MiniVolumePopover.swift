...
class MiniVolumePopover: BaseViewController {
...
extension MiniVolumePopover {
    ...
    func setupUI() {
        ...
        volumeSliderCell.knobColor = kWhiteHighlightColor
        volumeSliderCell.backgroundColor = kLightColor
        volumeSliderCell.progressColor = kLightestColor
...
extension MiniVolumePopover: DNSliderCellDelegate{
    //MARK: 拖动中
